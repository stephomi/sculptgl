define(function (require, exports, module) {
  ...
  GuiSDF.prototype = {
    ...
    _initGuiRepetition: function (menu) {
      ...
      ctrls.push(menu.addSlider('X dist', 50.0, this.onRepeatDist.bind(this, 0), 1.0, 100.0, 0.01));

      this._ctrlRepeat[1] = menu.addCheckbox('Repeat in Y', false, this.onRepeat.bind(this, 1));
      ctrls.push(menu.addSlider('Y dist', 50.0, this.onRepeatDist.bind(this, 1), 1.0, 100.0, 0.01));

      this._ctrlRepeat[2] = menu.addCheckbox('Repeat in Z', false, this.onRepeat.bind(this, 2));
      ctrls.push(menu.addSlider('Z dist', 50.0, this.onRepeatDist.bind(this, 2), 1.0, 100.0, 0.01));
    ...
    _initGuiPrimitive: function (menu) {
      ...
      // box sides
      this._ctrlBoxX = menu.addSlider('Side X', 2.0, this.onBoxSides.bind(this, 0), 0.1, 20.0, 0.01);
      this._ctrlBoxY = menu.addSlider('Side Y', 4.0, this.onBoxSides.bind(this, 1), 0.1, 20.0, 0.01);
      this._ctrlBoxZ = menu.addSlider('Side Z', 8.0, this.onBoxSides.bind(this, 2), 0.1, 20.0, 0.01);
      this._ctrlBoxW = menu.addSlider('Radius', 2.0, this.onBoxSides.bind(this, 3), 0.0, 10.0, 0.01);
      ...
      // sphere radius
      this._ctrlSphereR = menu.addSlider('Radius', 4.0, this.onSphereRadius.bind(this), 0.1, 20.0, 0.01);
      this._ctrlSphereR._primitive = 'SPHERE';
      ctrls.push(this._ctrlSphereR);

      // torus radii
      this._ctrlTorusR1 = menu.addSlider('Radius', 4.0, this.onTorusRadii.bind(this, 0), 1.0, 40.0, 0.01);
      this._ctrlTorusR2 = menu.addSlider('Thickness radius', 0.5, this.onTorusRadii.bind(this, 1), 0.1, 5.0, 0.01);
      ...
      // capsule radii
      this._ctrlCapsuleR = menu.addSlider('Radius', 2.0, this.onCapsule.bind(this, 0), 0.1, 20.0, 0.01);
      this._ctrlCapsuleH = menu.addSlider('Height', 5.0, this.onCapsule.bind(this, 1), 0.1, 20.0, 0.01);
      ...
      // ellipsoid
      this._ctrlEllipsoidX = menu.addSlider('X', 2.0, this.onEllipsoid.bind(this, 0), 0.5, 20.0, 0.01);
      this._ctrlEllipsoidY = menu.addSlider('Y', 4.0, this.onEllipsoid.bind(this, 1), 0.5, 20.0, 0.01);
      this._ctrlEllipsoidZ = menu.addSlider('Z', 8.0, this.onEllipsoid.bind(this, 2), 0.5, 20.0, 0.01);
    ...
    _initGuiCombination: function (menu) {
      ...
      this._ctrlTransition = menu.addCombobox('Transition', 'COLUMNS', this.onTransition.bind(this), optTrans);

      // round
      this._ctrlRoundRadius = menu.addSlider('Roundness', 3.0, this.onRoundRadius.bind(this), 0.1, 40.0, 0.01);
      this._ctrlRoundRadius._transition = 'ROUND';
      ctrls.push(this._ctrlRoundRadius);

      // chamfer
      this._ctrlChamferRadius = menu.addSlider('Chamfer', 0.0, this.onChamferRadius.bind(this), 0.1, 20.0, 0.01);
      this._ctrlChamferRadius._transition = 'CHAMFER';
      ctrls.push(this._ctrlChamferRadius);

      // columns
      this._ctrlColumnsR = menu.addSlider('Radius', 3.0, this.onColumns.bind(this, 0), 0.1, 40.0, 0.01);
      ...
      // stairs
      this._ctrlStairsR = menu.addSlider('Radius', 3.0, this.onStairs.bind(this, 0), 0.1, 40.0, 0.01);
