...
c.add(this.sculpt_,"tool_",{Brush:Sculpt.tool.BRUSH,Inflate:Sculpt.tool.INFLATE,Rotate:Sculpt.tool.ROTATE,Smooth:Sculpt.tool.SMOOTH,Flatten:Sculpt.tool.FLATTEN}).name("Tool").onChange(function(a){b.sculpt_.tool_=parseInt(a,10)});c.add(this.sculpt_,"negative_").name("Negative");c.add(this.picking_,"rDisplay_",20,200).name("Radius");c.add(this.sculpt_,"intensity_",0,1).name("Intensity");c.open();a=a.addFolder("Topology");a.add(this.sculpt_,"topo_",{Static:Sculpt.topo.STATIC,Subdivision:Sculpt.topo.SUBDIVISION,
Decimation:Sculpt.topo.DECIMATION,Uniformisation:Sculpt.topo.UNIFORMISATION,"Adaptive (!!!)":Sculpt.topo.ADAPTIVE}).name("Tool").onChange(function(a){b.sculpt_.topo_=parseInt(a,10)});a.add(this.sculpt_,"detail_",0,1).name("Detail");a.open()},render:function(){var a=this.gl_;a.clear(a.COLOR_BUFFER_BIT|a.DEPTH_BUFFER_BIT);this.camera_.updateView();this.mesh_&&this.mesh_.render(this.camera_,this.picking_)},onWindowResize:function(){var a=$(window).width(),b=$(window).height();this.camera_.width_=a;this.camera_.height_=
b;$("#canvas").attr("width",a);$("#canvas").attr("height",b);var c=this.gl_;c.viewportWidth=a;c.viewportHeight=b;c.viewport(0,0,a,b);this.camera_.updateProjection();this.render()},onKeyDown:function(a){a.stopPropagation();var b=a.which;if(a.ctrlKey&&90===b)this.onUndo();else if(a.ctrlKey&&89===b)this.onRedo();else{if(37===b||81===b||65===b)this.camera_.moveX_=-1;else if(39===b||68===b)this.camera_.moveX_=1;if(38===b||90===b||87===b)this.camera_.moveZ_=-1;else if(40===b||83===b)this.camera_.moveZ_=
