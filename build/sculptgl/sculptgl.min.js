...
Math.min(g,d)),Math.min(c,k)),m=Math.min(Math.min(Math.max(m,e),Math.max(g,d)),Math.max(c,k));return 0<=m&&f<m},intersectSphere:function(a,b){var c=this.min_,f=this.max_,e=a[0],d=a[1],k=a[2],g=[0,0,0];g[0]=c[0]>e?c[0]:f[0]<e?f[0]:e;g[1]=c[1]>d?c[1]:f[1]<d?f[1]:d;g[2]=c[2]>k?c[2]:f[2]<k?f[2]:k;return vec3.sqrDist(a,g)<b},enlargeIfFlat:function(a){var b=this.min_,c=this.max_;b[0]===c[0]&&(b[0]-=a,c[0]+=a);b[1]===c[1]&&(b[1]-=a,c[1]+=a);b[2]===c[2]&&(b[2]-=a,c[2]+=a)}};function Camera(){this.mode_=Camera.mode.PLANE;this.type_=Camera.projType.PERSPECTIVE;this.rot_=quat.create();this.view_=mat4.create();this.proj_=mat4.create();this.lastNormalizedMouseXY_=[0,0];this.height_=this.width_=0;this.zoom_=20;this.transY_=this.transX_=0;this.speed_=1;this.moveZ_=this.moveX_=0;this.fov_=70;this.center_=[0,0,0];this.usePivot_=!0}Camera.mode={SPHERICAL:0,PLANE:1};Camera.projType={PERSPECTIVE:0,ORTHOGRAPHIC:1};
...
b,c,f){var e=this.gl_;this.vertexBuffer_=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,this.vertexBuffer_);e.bufferData(e.ARRAY_BUFFER,a,e.DYNAMIC_DRAW);this.normalBuffer_=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,this.normalBuffer_);e.bufferData(e.ARRAY_BUFFER,b,e.DYNAMIC_DRAW);this.colorBuffer_=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,this.colorBuffer_);e.bufferData(e.ARRAY_BUFFER,c,e.DYNAMIC_DRAW);this.indexBuffer_=e.createBuffer();e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,this.indexBuffer_);e.bufferData(e.ELEMENT_ARRAY_BUFFER,
f,e.STATIC_DRAW)},render:function(a,b,c,f,e){var d=this.gl_;d.useProgram(this.shaderProgram_);var k=b.interPoint_;b=b.rWorldSqr_;var g=mat4.create();mat4.mul(g,a.view_,c);c=mat4.create();mat4.mul(c,a.proj_,g);d.enableVertexAttribArray(this.vertexAttrib_);d.bindBuffer(d.ARRAY_BUFFER,this.vertexBuffer_);d.vertexAttribPointer(this.vertexAttrib_,3,d.FLOAT,!1,0,0);d.enableVertexAttribArray(this.normalAttrib_);d.bindBuffer(d.ARRAY_BUFFER,this.normalBuffer_);d.vertexAttribPointer(this.normalAttrib_,3,d.FLOAT,
!1,0,0);this.shaderType_!==Render.mode.WIREFRAME&&this.shaderType_!==Render.mode.NORMAL&&(d.enableVertexAttribArray(this.colorAttrib_),d.bindBuffer(d.ARRAY_BUFFER,this.colorBuffer_),d.vertexAttribPointer(this.colorAttrib_,3,d.FLOAT,!1,0,0));d.uniformMatrix4fv(this.mvMatrixUnif_,!1,g);d.uniformMatrix4fv(this.mvpMatrixUnif_,!1,c);this.shaderType_!==Render.mode.NORMAL&&d.uniformMatrix3fv(this.normalMatrixUnif_,!1,mat3.normalFromMat4(mat3.create(),g));d.uniform3fv(this.centerPickingUnif_,vec3.transformMat4([0,
0,0],k,g));d.uniform1f(this.radiusSquaredUnif_,b);switch(this.shaderType_){case Render.mode.PHONG:this.drawBuffer(f);break;case Render.mode.TRANSPARENCY:d.depthMask(!1);d.enable(d.BLEND);d.uniform3fv(this.lightPositionUnif_,e);this.drawBuffer(f);d.disable(d.BLEND);d.depthMask(!0);break;case Render.mode.WIREFRAME:d.enableVertexAttribArray(this.barycenterAttrib_);d.bindBuffer(d.ARRAY_BUFFER,this.barycenterBuffer_);d.vertexAttribPointer(this.barycenterAttrib_,3,d.FLOAT,!1,0,0);d.drawArrays(d.TRIANGLES,
0,f);break;case Render.mode.NORMAL:this.drawBuffer(f);break;default:d.activeTexture(d.TEXTURE0),d.bindTexture(d.TEXTURE_2D,this.reflectionLoc_),d.uniform1i(this.reflectionTexUnif_,0),this.drawBuffer(f)}},drawBuffer:function(a){var b=this.gl_;b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,this.indexBuffer_);b.drawElements(b.TRIANGLES,a,SculptGL.elementIndexType,0)},updateBuffers:function(a,b,c,f){if(this.shaderType_===Render.mode.WIREFRAME)this.makeWireframeBuffers(a,b,f);else{var e=this.gl_;e.bindBuffer(e.ARRAY_BUFFER,
this.vertexBuffer_);e.bufferData(e.ARRAY_BUFFER,a,e.DYNAMIC_DRAW);e.bindBuffer(e.ARRAY_BUFFER,this.normalBuffer_);e.bufferData(e.ARRAY_BUFFER,b,e.DYNAMIC_DRAW);e.bindBuffer(e.ARRAY_BUFFER,this.colorBuffer_);e.bufferData(e.ARRAY_BUFFER,c,e.DYNAMIC_DRAW);e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,this.indexBuffer_);e.bufferData(e.ELEMENT_ARRAY_BUFFER,f,e.STATIC_DRAW)}},makeWireframeBuffers:function(a,b,c){for(var f=this.gl_,e=new Float32Array(3*c.length),d=0,k=0,g=0,d=0;d<c.length;++d)k=3*d,g=3*c[d],e[k]=
a[g],e[k+1]=a[g+1],e[k+2]=a[g+2];f.bindBuffer(f.ARRAY_BUFFER,this.vertexBuffer_);f.bufferData(f.ARRAY_BUFFER,e,f.DYNAMIC_DRAW);a=new Float32Array(3*c.length);for(d=0;d<c.length;++d)k=3*d,g=3*c[d],a[k]=b[g],a[k+1]=b[g+1],a[k+2]=b[g+2];f.bindBuffer(f.ARRAY_BUFFER,this.normalBuffer_);f.bufferData(f.ARRAY_BUFFER,a,f.DYNAMIC_DRAW);b=new Float32Array(3*c.length);for(d=0;d<c.length/3;++d)k=9*d,b[k]=1,b[k+1]=0,b[k+2]=0,b[k+3]=0,b[k+4]=1,b[k+5]=0,b[k+6]=0,b[k+7]=0,b[k+8]=1;this.barycenterBuffer_||(this.barycenterBuffer_=
f.createBuffer());f.bindBuffer(f.ARRAY_BUFFER,this.barycenterBuffer_);f.bufferData(f.ARRAY_BUFFER,b,f.DYNAMIC_DRAW)}};function Sculpt(a){this.states_=a;this.mesh_=null;this.intensity_=0.75;this.tool_=Sculpt.tool.BRUSH;this.topo_=Sculpt.topo.SUBDIVISION;this.detailSubdivision_=0.75;this.detailDecimation_=0.1;this.culling_=this.clay_=this.negative_=!1;this.color_=[168,66,66];this.d2Max_=this.d2Min_=0;this.d2Thickness_=0.5;this.d2Move_=0;this.rotateData_={normal:[0,0,0],center:[0,0]};this.rotateDataSym_={normal:[0,0,0],center:[0,0]};this.dragDir_=[0,0,0];this.dragDirSym_=[0,0,0]}
...
"Wireframe (slow)":Render.mode.WIREFRAME,Normal:Render.mode.NORMAL,Clay:Render.mode.MATERIAL,Chavant:Render.mode.MATERIAL+1,Skin:Render.mode.MATERIAL+2,Drink:Render.mode.MATERIAL+3,"Red velvet":Render.mode.MATERIAL+4,Orange:Render.mode.MATERIAL+5,Bronze:Render.mode.MATERIAL+6};this.ctrlShaders_=a.add(new Render,"shaderType_",f).name("Shader");this.ctrlShaders_.onChange(function(a){b.mesh_&&(b.mesh_.render_.updateShaders(parseInt(a,10),b.textures_,b.shaders_),b.mesh_.updateBuffers(),b.render())});
...
break;case 54:case 102:this.gui_.ctrlSculpt_.setValue(Sculpt.tool.PINCH);break;case 55:case 103:this.gui_.ctrlSculpt_.setValue(Sculpt.tool.CREASE);break;case 56:case 104:this.gui_.ctrlSculpt_.setValue(Sculpt.tool.DRAG);break;case 57:case 105:this.gui_.ctrlSculpt_.setValue(Sculpt.tool.COLOR);break;case 78:this.gui_.ctrlNegative_.setValue(!this.sculpt_.negative_);break;case 37:case 81:case 65:this.camera_.moveX_=-1;break;case 39:case 68:this.camera_.moveX_=1;break;case 38:case 90:case 87:this.camera_.moveZ_=
-1;break;case 40:case 83:this.camera_.moveZ_=1}var c=this;-1===this.cameraTimer_&&(this.cameraTimer_=setInterval(function(){c.camera_.updateTranslation();c.render()},20))}},onKeyUp:function(a){a.stopPropagation();a.preventDefault();switch(a.which){case 37:case 81:case 65:case 39:case 68:this.camera_.moveX_=0;break;case 38:case 90:case 87:case 40:case 83:this.camera_.moveZ_=0;break;case 70:this.camera_.resetViewFront();this.render();break;case 84:this.camera_.resetViewTop();this.render();break;case 76:this.camera_.resetViewLeft(),
this.render()}-1!==this.cameraTimer_&&(0===this.camera_.moveX_&&0===this.camera_.moveZ_)&&(clearInterval(this.cameraTimer_),this.cameraTimer_=-1)},onMouseDown:function(a){a.stopPropagation();a.preventDefault();var b=a.pageX,c=a.pageY;a=this.mouseButton_=a.which;var f=Tablet.pressure(),e=this.usePenRadius_?f:1,f=this.usePenIntensity_?f:1;if(1===a){if(this.mesh_)if(this.sumDisplacement_=0,this.states_.start(),this.sculpt_.tool_===Sculpt.tool.ROTATE)this.sculpt_.startRotate(this.picking_,b,c,this.pickingSym_,
this.ptPlane_,this.nPlane_,this.symmetry_);else if(this.continuous_&&this.sculpt_.tool_!==Sculpt.tool.DRAG){this.pressureRadius_=e;this.pressureIntensity_=f;this.mouseX_=b;this.mouseY_=c;var d=this;this.sculptTimer_=setInterval(function(){d.sculpt_.sculptStroke(d.mouseX_,d.mouseY_,d.pressureRadius_,d.pressureIntensity_,d);d.render()},20)}else this.sculpt_.sculptStroke(b,c,e,f,this)}else 3===a&&(this.camera_.usePivot_&&this.picking_.intersectionMouseMesh(this.mesh_,b,c,e),this.camera_.start(b,c,this.picking_))},
