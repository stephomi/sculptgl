...
this.ctrlContinuous_=d.add(b,"continuous_").name("Continuous");this.ctrlSymmetry_=d.add(b,"symmetry_").name("Symmetry");this.ctrlSculptCulling_=d.add(b.sculpt_,"culling_").name("Sculpt culling");this.ctrlRadius_=d.add(b.picking_,"rDisplay_",5,200).name("Radius");this.ctrlIntensity_=d.add(b.sculpt_,"intensity_",0,1).name("Intensity");this.ctrlCut_=d.add(b,"cut_",0,1).name("Click to cut !");this.ctrlCut_.__li.hidden=!0;this.ctrlFillHoles_=d.add(b.sculpt_,"fillHoles_",0,1).name("fill holes (buggy)");
this.ctrlFillHoles_.__li.hidden=!0;d.open();this.foldTopo_=a.addFolder("Topology");this.foldTopo_.add(b.sculpt_,"topo_",{Static:Sculpt.topo.STATIC,Dynamic:Sculpt.topo.SUBDIVISION,"Adaptive (!)":Sculpt.topo.ADAPTIVE}).name("Tool").onChange(function(a){b.sculpt_.topo_=parseInt(a,10);a=b.sculpt_.topo_;var d=Sculpt.topo;c.ctrlDetailSubdivision_.__li.hidden=a===d.STATIC;c.ctrlDetailDecimation_.__li.hidden=a!==d.SUBDIVISION});this.ctrlDetailSubdivision_=this.foldTopo_.add(b.sculpt_,"detailSubdivision_",
0,1).name("Subdivision");this.ctrlDetailDecimation_=this.foldTopo_.add(b.sculpt_,"detailDecimation_",0,1).name("Decimation");this.foldTopo_.open();a=a.addFolder("Mesh");this.ctrlNbVertices_=a.add(this,"dummyFunc_").name("Ver : 0");this.ctrlNbTriangles_=a.add(this,"dummyFunc_").name("Tri : 0");d={Phong:Render.mode.PHONG,Transparency:Render.mode.TRANSPARENCY,"Wireframe (slow)":Render.mode.WIREFRAME,"Normal shader":Render.mode.NORMAL,Clay:Render.mode.MATERIAL,Chavant:Render.mode.MATERIAL+1,Skin:Render.mode.MATERIAL+
2,Drink:Render.mode.MATERIAL+3,"Red velvet":Render.mode.MATERIAL+4,Orange:Render.mode.MATERIAL+5,Bronze:Render.mode.MATERIAL+6};this.ctrlShaders_=a.add(new Render,"shaderType_",d).name("Shader");this.ctrlShaders_.onChange(function(a){b.mesh_&&(b.mesh_.render_.updateShaders(parseInt(a,10),b.textures_,b.shaders_),b.mesh_.updateBuffers(),b.render())});this.ctrlColor_=a.addColor(b.sculpt_,"color_").name("Color");this.ctrlColor_.onChange(function(a){3===a.length?b.sculpt_.color_=[a[0],a[1],a[2]]:7===a.length?
(a=parseInt(a.slice(1),16),b.sculpt_.color_=[a>>16,a>>8&255,a&255]):b.sculpt_.color_=[168,66,66]});a.open()},updateMesh:function(a){a&&(this.ctrlShaders_.object=a.render_,this.ctrlShaders_.updateDisplay(),this.updateMeshInfo(a.vertices_.length,a.triangles_.length))},updateMeshInfo:function(a,b){this.ctrlNbVertices_.name("Ver : "+a);this.ctrlNbTriangles_.name("Tri : "+b)},openFile:function(){$("#fileopen").trigger("click")},resetBackground:function(){var a=this.sculptgl_.background_;a&&(a.gl_.deleteTexture(a.backgroundLoc_),
this.sculptgl_.background_=null)},resetCamera:function(){this.sculptgl_.camera_.reset();this.sculptgl_.render()},importBackground:function(){$("#backgroundopen").trigger("click")},saveFileAsOBJ:function(){if(this.sculptgl_.mesh_){var a=[Export.exportOBJ(this.sculptgl_.mesh_)],a=new Blob(a,{type:"text/plain;charset=utf-8"});saveAs(a,"yourMesh.obj")}},saveFileAsPLY:function(){if(this.sculptgl_.mesh_){var a=[Export.exportPLY(this.sculptgl_.mesh_)],a=new Blob(a,{type:"text/plain;charset=utf-8"});saveAs(a,
"yourMesh.ply")}},saveFileAsSTL:function(){if(this.sculptgl_.mesh_){var a=[Export.exportSTL(this.sculptgl_.mesh_)],a=new Blob(a,{type:"text/plain;charset=utf-8"});saveAs(a,"yourMesh.stl")}},exportVerold:function(){this.sculptgl_.mesh_&&(""===this.keyVerold_?alert("Please enter a verold API Key."):Export.exportVerold(this.sculptgl_.mesh_,this.keyVerold_))},exportSketchfab:function(){this.sculptgl_.mesh_&&(""===this.keySketchfab_?alert("Please enter a sketchfab API Key."):Export.exportSketchfab(this.sculptgl_.mesh_,
