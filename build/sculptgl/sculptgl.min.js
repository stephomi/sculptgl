...
Octree.maxDepth_)this.constructCells(a);else for(k=0;k<b;++k)l=d[c[k]],l.tagFlag_=f,l.leaf_=this,l.posInLeaf_=k},constructCells:function(a){var b=this.child_,c=this.iTris_,e=this.aabbSplit_.min_,g=this.aabbSplit_.max_,d=e[0],h=e[1],f=e[2],k=g[0],l=g[1],m=g[2],n=this.aabbSplit_.computeCenter(),p=n[0],q=n[1],r=n[2],s=0.5*(k-d),t=0.5*(l-h),v=0.5*(m-f),u=this.depth_+1,w=new Aabb;b[0]=new Octree(this,u);b[0].build(a,c,w.setCopy(e,n));b[1]=new Octree(this,u);b[1].build(a,c,w.set(d+s,h,f,p+s,q,r));b[2]=
new Octree(this,u);b[2].build(a,c,w.set(p,q-t,r,k,l-t,m));b[3]=new Octree(this,u);b[3].build(a,c,w.set(d,h,f+v,p,q,r+v));b[4]=new Octree(this,u);b[4].build(a,c,w.set(d,h+t,f,p,q+t,r));b[5]=new Octree(this,u);b[5].build(a,c,w.set(p,q,r-v,k,l,m-v));b[6]=new Octree(this,u);b[6].build(a,c,w.setCopy(n,g));b[7]=new Octree(this,u);b[7].build(a,c,w.set(p-s,q,r,k-s,l,m));this.iTris_.length=0},intersectRay:function(a,b){if(this.aabbLoose_.intersectRay(a,b)){if(this.child_[0]){for(var c=[],e=this.child_,g=0;8>
...
f=a.vertexArray_,k=a.indexArray_,l=[0,0,0];vec3.sub(l,c,b);vec3.normalize(l,l);for(var l=a.octree_.intersectRay(b,[1/l[0],1/l[1],1/l[2]]),m=-1,n=l.length,p=[0,0,0],q=0;q<n;++q){var r=l[q],s=h[r],r=3*r,t=3*k[r],v=3*k[r+1],r=3*k[r+2];if(Geometry.intersectionRayTriangle(b,c,[f[t],f[t+1],f[t+2]],[f[v],f[v+1],f[v+2]],[f[r],f[r+1],f[r+2]],s.normal_,p)&&(s=vec3.sqrDist(b,p),s<m||-1===m))m=s,vec3.copy(this.interPoint_,p),this.pickedTriangle_=l[q]}-1!==this.pickedTriangle_?(this.mesh_=a,a=[0,0,0],vec3.transformMat4(a,
...
switch(this.topo_){case Sculpt.topo.SUBDIVISION:n=p.subdivision(n,this.d2Max_);break;case Sculpt.topo.DECIMATION:n=p.decimation(n,this.d2Min_);break;case Sculpt.topo.UNIFORMISATION:case Sculpt.topo.ADAPTIVE:n=p.subdivision(n,this.d2Max_),n=p.decimation(n,this.d2Min_)}for(var f=h.getVerticesFromTriangles(n),q=f.length,r=[],s=[],t=Vertex.sculptMask_,v=h.normalArray_,u=m[0],w=m[1],m=m[2],y=0;y<q;++y){var x=f[y];if(a[x].sculptFlag_===t){r.push(x);var z=3*x;0>=v[z]*u+v[z+1]*w+v[z+2]*m&&s.push(x)}}if(0!==
s.length)switch(this.culling_&&(r=s),this.tool_){case Sculpt.tool.BRUSH:this.flatten(l,r,s,k,0.5*this.intensity_);this.brush(l,r,s,k,this.intensity_);break;case Sculpt.tool.INFLATE:this.inflate(l,r,k,this.intensity_);break;case Sculpt.tool.ROTATE:this.rotate(l,r,k,b,c,e,g,d);break;case Sculpt.tool.SMOOTH:this.smooth(r,this.intensity_);break;case Sculpt.tool.FLATTEN:this.flatten(l,r,s,k,this.intensity_);break;case Sculpt.tool.PINCH:this.pinch(l,r,k,this.intensity_);break;case Sculpt.tool.CREASE:this.crease(l,
r,s,k,this.intensity_)}this.topo_===Sculpt.topo.ADAPTIVE&&(n=p.adaptTopology(n,this.d2Thickness_),f=h.getVerticesFromTriangles(n));h.updateMesh(n,f)},brush:function(a,b,c,e,g){var d=this.areaNormal(c);if(d){c=this.mesh_.vertexArray_;e=Math.sqrt(e);var h=b.length;g=0.1*g*e;this.topo_===Sculpt.topo.ADAPTIVE&&(g=Math.min(Math.sqrt(this.d2Move_),g));this.negative_&&(g=-g);var f=a[0],k=a[1];a=a[2];for(var l=d[0],m=d[1],d=d[2],n=0;n<h;++n){var p=3*b[n],q=c[p]-f,r=c[p+1]-k,s=c[p+2]-a,q=Math.sqrt(q*q+r*r+
s*s)/e,q=3*q*q*q*q-4*q*q*q+1,q=g*q;c[p]+=l*q;c[p+1]+=m*q;c[p+2]+=d*q}}},inflate:function(a,b,c,e){var g=this.mesh_,d=g.vertexArray_,g=g.normalArray_,h=b.length;c=Math.sqrt(c);e=0.1*e*c;this.topo_===Sculpt.topo.ADAPTIVE&&(e=Math.min(Math.sqrt(this.d2Move_),e));this.negative_&&(e=-e);var f=a[0],k=a[1];a=a[2];for(var l=0;l<h;++l){var m=3*b[l],n=d[m]-f,p=d[m+1]-k,q=d[m+2]-a,n=Math.sqrt(n*n+p*p+q*q)/c,n=3*n*n*n*n-4*n*n*n+1,n=e*n;d[m]+=g[m]*n;d[m+1]+=g[m+1]*n;d[m+2]+=g[m+2]*n}},startRotate:function(a,b,
...
g);a.mesh_&&(a.pickVerticesInSphere(a.rWorldSqr_),a=[0,0,0],vec3.sub(a,b,c),d.normal=vec3.normalize(a,a),d.center2d=[e,g])},rotate:function(a,b,c,e,g,d,h,f){var k=this.rotateData_;f&&(k=this.rotateDataSym_);f=k.center2d;g=[e-f[0],g-f[1]];if(!(30>vec2.len(g))){vec2.normalize(g,g);k=k.normal;e=[0,0,0,0];d=[d-f[0],h-f[1]];vec2.normalize(d,d);d=Geometry.signedAngle2d(g,d);h=this.mesh_.vertexArray_;c=Math.sqrt(c);f=b.length;g=a[0];for(var l=a[1],m=a[2],n=0;n<f;++n){var p=3*b[n],q=h[p]-g,r=h[p+1]-l,s=h[p+
2]-m,q=Math.sqrt(q*q+r*r+s*s)/c,r=[h[p],h[p+1],h[p+2]];quat.setAxisAngle(e,k,d*(3*q*q*q*q-4*q*q*q+1));vec3.sub(r,r,a);vec3.transformQuat(r,r,e);vec3.add(r,r,a);h[p]=r[0];h[p+1]=r[1];h[p+2]=r[2]}}},smooth:function(a,b){var c=this.mesh_.vertexArray_,e=a.length,g=new Float32Array(3*e);this.laplacianSmooth(a,g);for(var d=this.d2Move_,h=Math.sqrt(d),f=this.topo_===Sculpt.topo.ADAPTIVE,k=0;k<e;++k){var l=3*a[k],m=3*k,n=(g[m]-c[l])*b,p=(g[m+1]-c[l+1])*b,m=(g[m+2]-c[l+2])*b;if(f){var q=n*n+p*p+m*m;q>d&&(q=
h/Math.sqrt(q),n*=q,p*=q,m*=q)}c[l]+=n;c[l+1]+=p;c[l+2]+=m}},flatten:function(a,b,c,e,g){var d=this.areaNormal(c);if(d){var h=this.areaCenter(c);c=this.mesh_.vertexArray_;e=Math.sqrt(e);var f=b.length;g*=0.3;var k=a[0],l=a[1];a=a[2];for(var m=h[0],n=h[1],h=h[2],p=d[0],q=d[1],d=d[2],r=Math.sqrt(this.d2Move_),s=this.topo_===Sculpt.topo.ADAPTIVE,t=0;t<f;++t){var v=3*b[t],u=c[v],w=c[v+1],y=c[v+2],x=(u-m)*p+(w-n)*q+(y-h)*d,u=u-k,w=w-l,y=y-a,y=Math.sqrt(u*u+w*w+y*y)/e,y=3*y*y*y*y-4*y*y*y+1,y=s?Math.min(r,
x*g*y):x*g*y;c[v]-=p*y;c[v+1]-=q*y;c[v+2]-=d*y}}},pinch:function(a,b,c,e){var g=this.mesh_.vertexArray_;c=Math.sqrt(c);var d=b.length,h=a[0],f=a[1];a=a[2];var k=Math.sqrt(this.d2Move_),l=this.topo_===Sculpt.topo.ADAPTIVE;e=0.005*e*c;for(var m=0;m<d;++m){var n=3*b[m],p=g[n],q=g[n+1],r=g[n+2],s=p-h,t=q-f,v=r-a,s=Math.sqrt(s*s+t*t+v*v)/c,s=3*s*s*s*s-4*s*s*s+1,s=l?Math.min(k,e*s):e*s;g[n]+=(h-p)*s;g[n+1]+=(f-q)*s;g[n+2]+=(a-r)*s}},crease:function(a,b,c,e,g){var d=this.areaNormal(c);if(d){c=this.mesh_.vertexArray_;
e=Math.sqrt(e);var h=b.length,f=a[0],k=a[1];a=a[2];var l=d[0],m=d[1],d=d[2],n=Math.sqrt(this.d2Move_),p=this.topo_===Sculpt.topo.ADAPTIVE;g=0.005*g*e;var q=10;this.negative_&&(q=-10);for(var r=0;r<h;++r){var s=3*b[r],t=c[s],v=c[s+1],u=c[s+2],w=t-f,y=v-k,x=u-a,w=Math.sqrt(w*w+y*y+x*x)/e,x=3*w*w*w*w-4*w*w*w+1,z=g*Math.pow(2-x,-20)*q,x=g*x,w=(f-t)*x+l*z,y=(k-v)*x+m*z,x=(a-u)*x+d*z;p&&(t=w*w+y*y+x*x,t>d2Move&&(t=n/Math.sqrt(t),w*=t,y*=t,x*=t));c[s]+=w;c[s+1]+=y;c[s+2]+=x}}},smoothFlat:function(a,b){var c=
this.mesh_,e=c.vertexArray_,c=c.normalArray_,g=a.length,d=new Float32Array(3*g);this.laplacianSmooth(a,d);for(var h=0;h<g;++h){var f=3*a[h],k=e[f],l=e[f+1],m=e[f+2],n=c[f],p=c[f+1],q=c[f+2],r=3*h,s=d[r],t=d[r+1],r=d[r+2],v=n*(s-k)+p*(t-l)+q*(r-m);e[f]+=(s-n*v-k)*b;e[f+1]+=(t-p*v-l)*b;e[f+2]+=(r-q*v-m)*b}},laplacianSmooth:function(a,b){for(var c=this.mesh_,e=c.vertices_,c=c.vertexArray_,g=a.length,d=0;d<g;++d){var h=3*d,f=e[a[d]],k=f.ringVertices_,l=k.length,m=0,n=0,p=0,q=0,r=0;if(l!==f.tIndices_.length){for(q=
f=0;q<l;++q){var r=k[q],s=e[r];s.ringVertices_.length!==s.tIndices_.length&&(r*=3,m+=c[r],n+=c[r+1],p+=c[r+2],++f)}b[h]=m/f;b[h+1]=n/f;b[h+2]=p/f}else{for(q=0;q<l;++q)r=3*k[q],m+=c[r],n+=c[r+1],p+=c[r+2];b[h]=m/l;b[h+1]=n/l;b[h+2]=p/l}}},areaNormal:function(a){for(var b=this.mesh_.normalArray_,c=a.length,e=0,g=0,d=0,h=0;h<c;++h)var f=3*a[h],e=e+b[f],g=g+b[f+1],d=d+b[f+2];a=Math.sqrt(e*e+g*g+d*d);if(0===a)return null;a=1/a;return[e*a,g*a,d*a]},areaCenter:function(a){for(var b=this.mesh_.vertexArray_,
...
(q+F)-0.12*k[u+1]*H*D,f[u+2]=0.5*(t+A)-0.12*k[u+2]*H*D);l.stateFlag_=Mesh.stateMask_;l.ringVertices_.push(b,c,e);n.replaceRingVertex(c,v);p.replaceRingVertex(b,v);l.tIndices_.push(a,r);d.push(l)}else b=d[v],b.ringVertices_.push(e),b.tIndices_.push(a,r);g.push(r);h.push(s)};
Topology.prototype.fillTriangles=function(a){for(var b=this.mesh_,c=b.vertices_,e=b.triangles_,b=b.indexArray_,g=a.length,d=[],h=0;h<g;++h){var f=a[h],k=3*f,l=b[k],m=b[k+1],k=b[k+2],n=this.verticesMap_,p=n[[Math.min(l,m),Math.max(l,m)]],q=n[[Math.min(m,k),Math.max(m,k)]],n=n[[Math.min(l,k),Math.max(l,k)]],r=c[l].ringVertices_.length,s=c[m].ringVertices_.length,t=c[k].ringVertices_.length,v=0;p?v=q?n?r<s&&r<t?2:s<t?3:1:r<t?2:1:n&&s<t?3:1:q?v=n&&s<r?3:2:n&&(v=3);if(1===v)this.fillTriangle(f,l,m,k,p);
...
Topology.prototype.fillTriangle=function(a,b,c,e,g){var d=this.mesh_,h=d.vertices_,f=d.triangles_,d=d.indexArray_,k=3*a;d[k]=b;d[k+1]=g;d[k+2]=e;b=f[a].leaf_;var l=b.iTris_,m=h[c],n=h[e],k=h[g];k.ringVertices_.push(e);n.ringVertices_.push(g);h=f.length;k.tIndices_.push(a,h);var p=new Triangle(h),k=3*h;d[k]=g;d[k+1]=c;d[k+2]=e;p.stateFlag_=Mesh.stateMask_;p.leaf_=b;p.posInLeaf_=l.length;n.tIndices_.push(h);m.replaceTriangle(a,h);l.push(h);f.push(p)};Topology.prototype.decimation=function(a,b){for(var c=0,e=this.radiusSquared_,g=Math.sqrt(e),d=this.mesh_,h=d.triangles_,f=d.vertexArray_,d=d.indexArray_,k=this.center_,l=k[0],m=k[1],k=k[2],n=0;n<a.length;++n){var p=a[n];if(!(0>h[p].tagFlag_)){var c=3*p,q=d[c],r=d[c+1],s=d[c+2],c=3*q,t=f[c],v=f[c+1],u=f[c+2],c=3*r,w=f[c],y=f[c+1],x=f[c+2],c=3*s,z=f[c],E=f[c+1],F=f[c+2],A=(t+w+z)/3-l,B=(v+y+E)/3-m,C=(u+x+F)/3-k,c=A*A+B*B+C*C;if(c<e)c=1;else if(c<2*e)c=(Math.sqrt(c)-g)/(g*Math.SQRT2-g),c=3*c*c*c*c-
4*c*c*c+1;else continue;var A=w-t,B=y-v,C=x-u,G=A*A+B*B+C*C,A=w-z,B=y-E,C=x-F,w=A*A+B*B+C*C,A=t-z,B=v-E,C=u-F,t=A*A+B*B+C*C;G<w&&G<t?G<b*c&&this.decimateTriangles(p,this.findOppositeTriangle(p,q,r),a):w<t?w<b*c&&this.decimateTriangles(p,this.findOppositeTriangle(p,r,s),a):t<b*c&&this.decimateTriangles(p,this.findOppositeTriangle(p,q,s),a)}}this.applyDeletion();return this.getValidModifiedTriangles(this.getValidModifiedVertices(),a)};
...
Topology.prototype.deleteVertex=function(a){var b=this.mesh_,c=b.vertices_,e=b.triangles_,g=b.vertexArray_,d=b.normalArray_,h=b.indexArray_,b=c.length-1;if(a!==b){var f=0,k=c[b],f=3*b,l=g[f],m=g[f+1],n=g[f+2],p=d[f],q=d[f+1],r=d[f+2],s=Mesh.stateMask_,t=this.states_.undos_[this.states_.curUndoIndex_];k.stateFlag_!==s&&(k.stateFlag_=s,t.vState_.push(k.clone()),t.vArState_.push(l,m,n),t.nArState_.push(p,q,r));k.id_=a;for(var v=k.tIndices_,u=k.ringVertices_,w=v.length,y=u.length,x=0,x=0;x<w;++x){var f=
v[x],z=e[f],f=3*f;z.stateFlag_!==s&&(z.stateFlag_=s,t.tState_.push(z.clone()),t.iArState_.push(h[f],h[f+1],h[f+2]));h[f]===b?h[f]=a:h[f+1]===b?h[f+1]=a:h[f+2]=a}for(x=0;x<y;++x)f=u[x],e=c[f],e.stateFlag_!==s&&(f*=3,e.stateFlag_=s,t.vState_.push(e.clone()),t.vArState_.push(g[f],g[f+1],g[f+2]),t.nArState_.push(d[f],d[f+1],d[f+2])),e.replaceRingVertex(b,a);c[a]=k;f=3*a;g[f]=l;g[f+1]=m;g[f+2]=n;d[f]=p;d[f+1]=q;d[f+2]=r}c.pop()};Topology.prototype.adaptTopology=function(a,b){for(var c=this.mesh_,e=c.triangles_,g=c.vertexArray_,d=this.radiusSquared_,h=c.getVerticesFromTriangles(a),f=h.length,k=[],l=c.vertices_.length,m=0,n=0,m=this.center_,p=m[0],q=m[1],r=m[2],s=0,t=0,m=n=0;m<f;++m){var v=h[m];v>=l||(n=3*v,s=g[n]-p,t=g[n+1]-q,n=g[n+2]-r,s*s+t*t+n*n<d&&k.push(v))}this.checkCollisions(k,b);m=c.getTrianglesFromVertices(this.iVertsDecimated_);a.push.apply(a,m);c=[];g=a.length;d=e.length;++Triangle.tagMask_;h=Triangle.tagMask_;
...
++Vertex.tagMask_;for(m=0;m<p;++m)e[d[m]].tagFlag_=Vertex.tagMask_;for(var d=3*f,q=g[d],r=g[d+1],s=g[d+2],t=n.getNeighborhood(q,r,s),v=t.length,m=0;m<v;++m){var u=t[m];if(f!==u){var w=e[u];if(!(0>w.tagFlag_||w.tagFlag_===Vertex.tagMask_)){var d=3*u,y=q-g[d],x=r-g[d+1],d=s-g[d+2];if(y*y+x*x+d*d<h){p>w.ringVertices_.length?this.vertexJoin(f,u):this.vertexJoin(u,f);break}}}}}this.applyDeletion();h=this.iVertsDecimated_=this.getValidModifiedVertices();k=h.length;g=[];n=Vertex.sculptMask_;for(l=0;l<k;++l)d=
...
[];this.trianglesRotate(h.tIndices_,a,t);if(this.adjustEdgeOrientation(t)){for(var s=t.length,v=t[0].v1,u=-1,f=0,f=1;f<s-1;++f)if(t[f].v2===v){u=f;break}if(-1!==u){this.checkArrayLength(1);s=c.length;v=new Vertex(s);v.stateFlag_=r;f=3*s;e[f]=k;e[f+1]=l;e[f+2]=m;g[f]=-n;g[f+1]=-p;g[f+2]=-q;for(f=0;f<=u;++f)e=t[f].t,v.tIndices_.push(e),h.removeTriangle(e),d[3*e+2]=s;c.push(v);b.computeRingVertices(a);b.computeRingVertices(s);c=v.ringVertices_;d=c.length;for(f=0;f<d;++f)b.computeRingVertices(c[f]);h=
...
b,c,this.pickingSym_,this.ptPlane_,this.nPlane_):this.sculpt_.startRotate(this.picking_,b,c))):3===a&&this.camera_.start(b,c)},onMouseUp:function(a){a.stopPropagation();a.preventDefault();this.mesh_&&this.mesh_.checkLeavesUpdate();this.mouseButton_=0},onMouseWheel:function(a,b){a.stopPropagation();a.preventDefault();this.camera_.zoom(b/100);this.render()},onMouseMove:function(a){a.stopPropagation();a.preventDefault();var b=a.pageX;a=a.pageY;var c=Tablet.pressure();this.mesh_&&1!==this.mouseButton_&&
this.picking_.intersectionMouseMesh(this.mesh_,b,a,c);1===this.mouseButton_?(this.sculpt_.tool_!==Sculpt.tool.ROTATE?this.sculptStroke(b,a,c):this.picking_.mesh_&&(this.picking_.pickVerticesInSphere(this.picking_.rWorldSqr_),this.sculpt_.sculptMesh(this.picking_,b,a,this.lastMouseX_,this.lastMouseY_),this.symmetry_&&(this.pickingSym_.pickVerticesInSphere(this.pickingSym_.rWorldSqr_),this.sculpt_.sculptMesh(this.pickingSym_,this.lastMouseX_,this.lastMouseY_,b,a,!0))),this.mesh_.updateBuffers(),this.ctrlNbVertices_.name("Ver : "+
this.mesh_.vertices_.length),this.ctrlNbTriangles_.name("Tri : "+this.mesh_.triangles_.length)):3===this.mouseButton_?this.camera_.rotate(b,a):2===this.mouseButton_&&this.camera_.translate((b-this.lastMouseX_)/3E3,(a-this.lastMouseY_)/3E3);this.lastMouseX_=b;this.lastMouseY_=a;this.render()},sculptStroke:function(a,b,c){var e=this.ptPlane_,g=this.nPlane_,d=this.picking_,h=this.pickingSym_,f=a-this.lastMouseX_,k=b-this.lastMouseY_,l=Math.sqrt(f*f+k*k);this.sumDisplacement_+=l;var m=0.2*d.rDisplay_,
n=l/Math.floor(l/m),f=f/l,k=k/l;a=this.lastMouseX_;b=this.lastMouseY_;var p=this.mesh_,q=this.symmetry_,r=this.sculpt_;if(this.sumDisplacement_>50*m)this.sumDisplacement_=0;else if(this.sumDisplacement_>m)for(m=this.sumDisplacement_=0;m<l;m+=n){d.intersectionMouseMesh(p,a,b,c);if(!d.mesh_)break;d.pickVerticesInSphere(d.rWorldSqr_);r.sculptMesh(d);if(q){h.intersectionMouseMesh(p,a,b,c,e,g);if(!h.mesh_)break;h.rWorldSqr_=d.rWorldSqr_;h.pickVerticesInSphere(h.rWorldSqr_);r.sculptMesh(h)}a+=f*n;b+=k*
...
Files.loadOBJ(this.sphere_,this.mesh_);this.endMeshLoad()},startMeshLoad:function(){this.mesh_=new Mesh(this.gl_);this.states_.reset();this.states_.mesh_=this.mesh_;this.sculpt_.mesh_=this.mesh_;Mesh.stateMask_=1;Vertex.tagMask_=1;Vertex.sculptMask_=1;Triangle.tagMask_=1},endMeshLoad:function(){var a=this.mesh_;a.render_.shaderType_=Render.mode.MATERIAL;a.initMesh(this.textures_,this.shaders_);a.moveTo([0,0,0]);a=vec3.dist(a.octree_.aabbLoose_.max_,a.octree_.aabbLoose_.min_);this.camera_.reset();
this.camera_.globalScale_=a;this.camera_.zoom(-0.4);this.updateGuiMesh();this.render()},updateGuiMesh:function(){if(this.mesh_){var a=this.mesh_;this.ctrlColor_.object=a.render_;this.ctrlColor_.updateDisplay();this.ctrlShaders_.object=a.render_;this.ctrlShaders_.updateDisplay();this.ctrlNbVertices_.name("Ver : "+a.vertices_.length);this.ctrlNbTriangles_.name("Tri : "+a.triangles_.length)}},openFile:function(){$("#fileopen").trigger("click")},saveFile:function(){if(this.mesh_){var a=[Files.exportOBJ(this.mesh_)],
a=new Blob(a,{type:"text/plain;charset=utf-8"});saveAs(a,"yourMesh.obj")}},onUndo:function(){this.states_.undo();this.render();this.updateGuiMesh()},onRedo:function(){this.states_.redo();this.render();this.updateGuiMesh()}};
