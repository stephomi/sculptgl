...
f=3*this.pickedTriangle_,this.pickedVertices_.push(a[f],a[f+1],a[f+2]))},computeRadiusWorldSq:function(a,b,c){var d=[0,0,0];vec3.transformMat4(d,this.interPoint_,this.mesh_.matTransform_);var e=this.camera_.project(d)[2];a=this.camera_.unproject(a+this.rDisplay_*c,b,e);this.rWorldSqr_=vec3.sqrDist(d,a)}};function Render(a){this.gl_=a;this.shaderType_=Render.mode.PHONG;this.cacheDrawArraysN_=this.cacheDrawArraysV_=this.reflectionTexUnif_=this.lineNormalUnif_=this.lineOriginUnif_=this.radiusSquaredUnif_=this.centerPickingUnif_=this.normalMatrixUnif_=this.mvMatrixUnif_=this.mvpMatrixUnif_=this.normalAttrib_=this.colorAttrib_=this.vertexAttrib_=this.vertexShader_=this.fragmentShader_=this.shaderProgram_=this.reflectionLoc_=this.indexBuffer_=this.colorBuffer_=this.normalBuffer_=this.vertexBuffer_=null}
...
Wireframe:Render.mode.WIREFRAME,"Normal shader":Render.mode.NORMAL,Clay:Render.mode.MATERIAL,Chavant:Render.mode.MATERIAL+1,Skin:Render.mode.MATERIAL+2,Drink:Render.mode.MATERIAL+3,"Red velvet":Render.mode.MATERIAL+4,Orange:Render.mode.MATERIAL+5,Bronze:Render.mode.MATERIAL+6};this.ctrlShaders_=a.add(new Render,"shaderType_",d).name("Shader");this.ctrlShaders_.onChange(function(a){b.mesh_&&(b.mesh_.render_.updateShaders(parseInt(a,10),b.textures_,b.shaders_),b.mesh_.updateBuffers(),b.render())});
this.ctrlColor_=a.addColor(b.sculpt_,"color_").name("Color");this.ctrlColor_.onChange(function(a){3===a.length?b.sculpt_.color_=[a[0],a[1],a[2]]:7===a.length?(a=parseInt(a.slice(1),16),b.sculpt_.color_=[a>>16,a>>8&255,a&255]):b.sculpt_.color_=[168,66,66]});a.open()},updateMesh:function(a){a&&(this.ctrlShaders_.object=a.render_,this.ctrlShaders_.updateDisplay(),this.updateMeshInfo(a.vertices_.length,a.triangles_.length))},updateMeshInfo:function(a,b){this.ctrlNbVertices_.name("Ver : "+a);this.ctrlNbTriangles_.name("Tri : "+
b)},openFile:function(){$("#fileopen").trigger("click")},resetBackground:function(){var a=this.sculptgl_.background_;a&&(a.gl_.deleteTexture(a.backgroundLoc_),this.sculptgl_.background_=null)},resetCamera:function(){this.sculptgl_.camera_.reset();this.sculptgl_.render()},importBackground:function(){$("#backgroundopen").trigger("click")},saveFileAsOBJ:function(){if(this.sculptgl_.mesh_){var a=[Export.exportOBJ(this.sculptgl_.mesh_)],a=new Blob(a,{type:"text/plain;charset=utf-8"});saveAs(a,"yourMesh.obj")}},
saveFileAsPLY:function(){if(this.sculptgl_.mesh_){var a=[Export.exportPLY(this.sculptgl_.mesh_)],a=new Blob(a,{type:"text/plain;charset=utf-8"});saveAs(a,"yourMesh.ply")}},saveFileAsSTL:function(){if(this.sculptgl_.mesh_){var a=[Export.exportSTL(this.sculptgl_.mesh_)],a=new Blob(a,{type:"text/plain;charset=utf-8"});saveAs(a,"yourMesh.stl")}},exportVerold:function(){this.sculptgl_.mesh_&&(""===this.keyVerold_?alert("Please enter a verold API Key."):Export.exportVerold(this.sculptgl_.mesh_,this.keyVerold_))},
exportSketchfab:function(){this.sculptgl_.mesh_&&(""===this.keySketchfab_?alert("Please enter a sketchfab API Key."):Export.exportSketchfab(this.sculptgl_.mesh_,this.keySketchfab_))}};function SculptGL(){this.gl_=null;this.mouseButton_=this.sumDisplacement_=this.lastMouseY_=this.lastMouseX_=0;this.cameraTimer_=-1;this.usePenRadius_=!0;this.continuous_=this.symmetry_=this.usePenIntensity_=!1;this.sculptTimer_=-1;this.mouseY_=this.mouseX_=this.pressureIntensity_=this.pressureRadius_=0;this.ptPlane_=[0,0,0];this.nPlane_=[1,0,0];this.states_=new States;this.camera_=new Camera;this.picking_=new Picking(this.camera_);this.pickingSym_=new Picking(this.camera_);this.sculpt_=new Sculpt(this.states_);
